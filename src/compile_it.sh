...
if [ $# -eq 0 ]
	then
		...
		#gcc -O2 -fno-builtin -Wall -Wextra -Werror insert_sort.c parser.c dlist.c readdir.c files.c display.c main.c error.c -I../libft/include -I../include ../libft/libft.a -o ft_ls
